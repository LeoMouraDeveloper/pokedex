...
let fillGeneral = () => {
    ...
    .then((pokemon) => {
        ...
        <h3 class="txt-dark-gray">Reprodução</h3>
        <ol>
            <li class="list">
                <span class="txt-${pokemon.types[0]} bold">Gênero</span>
                <span class="txt-dark-gray bold">Masculino: <span class="txt-light-gray">${pokemon.gender.male}</span></span>
                <span class="txt-dark-gray bold">Feminino:<span class="txt-light-gray"> ${pokemon.gender.female}</span></span>
            </li>
            <li class="list">
                <span class="txt-${pokemon.types[0]} bold">Grupo</span>
                ${pokemon.eggGroups.map((eggGroup) => `<span class="txt-light-gray">${eggGroup}</span>`).join('')}
            </li>
            <li class="list">
                <span class="txt-${pokemon.types[0]} bold">Ciclo</span>
...
let fillStats = () => {
    ...
    .then((pokemon) => {
        pokemonClick.innerHTML = `<ol>
            ...
            <li class="d-flex stat"">
                <span class="stat-span txt-${pokemon.types[0]} bold">S.ATK</span>
                <span class="txt-light-gray">${pokemon.stats[3]}</span>
                <div class="progress-bar-satk border-radius"></div>
            </li>
            <li class="d-flex stat"">
                <span class="stat-span txt-${pokemon.types[0]} bold">S.DEF</span>
...
let fillEvolutions = () => {
    pokemonClick.innerHTML = `<div class="txt-dark-gray">Em Construção</div>`
    ...
    .then((pokemon) => {
        ...
        pokemonContent.innerHTML = `
            ...
            <div class="pokemon-info txt-center">
                ...
                <p class="txt-light-gray">Descubra <span class="name">${pokemon.name}'s</span> ${pokemon.types[0]}-baseados em poderes e junte-se à sua emocionante jornada no mundo Pokémon!</p>
            </div>
            <ol class="d-flex padding">
                ...
                <li>
                    <button id="stats" class="padding txt-${pokemon.types[0]}" onclick="fillStats()">Status</button>
                    </li>
                <li>
        ...
        <ol>
            <li class="list">
                <span class="txt-${pokemon.types[0]} bold">Gênero</span>
                <span class="txt-dark-gray bold">Masculino: <span class="txt-light-gray">${pokemon.gender.male}</span></span>
                <span class="txt-dark-gray bold">Femenino: <span class="txt-light-gray">${pokemon.gender.female}</span></span>
            </li>
            <li class="list">
                <span class="txt-${pokemon.types[0]} bold">Grupo</span>
                ${pokemon.eggGroups.map((eggGroup) => `<span class="txt-light-gray">${eggGroup}</span>`).join('')}
